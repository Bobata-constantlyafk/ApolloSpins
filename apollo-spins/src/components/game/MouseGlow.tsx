...
const WISPS = [
  { x: 0,  y: 300, r: 88,  alpha: 0.11, speed: 0.016, amt: 6,  phase: 0.0,  px: 0.13, py: 0.07 },
  { x: 1170, y: 210, r: 72,  alpha: 0.09, speed: 0.013, amt: 5,  phase: 1.3,  px: 0.08, py: 0.05 },
  { x: 660, y: 120, r: 52,  alpha: 0.07, speed: 0.015, amt: 5,  phase: 0.9,  px: 0.10, py: 0.06 },
  { x: 120,  y: 420, r: 48,  alpha: 0.08, speed: 0.018, amt: 4,  phase: 3.7,  px: 0.06, py: 0.04 },
  { x: 1060, y: 635, r: 64,  alpha: 0.09, speed: 0.011, amt: 6,  phase: 1.9,  px: 0.11, py: 0.07 },
  { x: 900,  y: 668, r: 44,  alpha: 0.07, speed: 0.022, amt: 4,  phase: 4.2,  px: 0.05, py: 0.03 },
] as const;
